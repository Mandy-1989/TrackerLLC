...
import React, { Component } from 'react';
import { View, StyleSheet, SafeAreaView, ActivityIndicator, Platform, TouchableOpacity, Image } from 'react-native';
        ...
        return (
            ...
            >
                <View>
                    ...
                    <Image source={require('../assets/images/earth_icon.png')} style={{ width: 20, height: 20 }}>
                    </Image>
                </View>
            </Marker>
